...
int main()
{
	...
	const auto materialCenter = std::make_unique<Lambertian>(Color(0.7, 0.3, 0.3));
	const auto materialLeft = std::make_unique<Metal>(Color(0.8, 0.8, 0.8), 0.3f);
	const auto materialRight = std::make_unique<Metal>(Color(0.8, 0.6, 0.2), 1.0f);
